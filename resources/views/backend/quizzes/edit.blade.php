                            ...
                            <div class="card-body">
                                <form method="POST" action="{{ route('quizzes.update', $quiz->id) }}">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" name="title" value="{{ old('title', $quiz->title) }}" required placeholder="Masukkan judul quiz">
                                        @error('title')
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea class="form-control" name="description" rows="3" placeholder="Masukkan deskripsi quiz">{{ old('description', $quiz->description) }}</textarea>
                                        @error('description')
                                            <div class="text-danger small mt-1">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <input type="number" class="form-control" name="time_limit" value="{{ old('time_limit', $quiz->time_limit) }}" required min="1" placeholder="30">
                                            @error('time_limit')
                                                <div class="text-danger small mt-1">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <input type="number" class="form-control" name="passing_score" value="{{ old('passing_score', $quiz->passing_score) }}" required min="0" max="100" placeholder="70">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select class="form-control" name="status" required>
                                            ...
                                            <option value="publish" {{ old('status', $quiz->status) == 'publish' ? 'selected' : '' }}>Publish</option>
                                    ...
                                    <div class="d-flex gap-2 mt-4">
                                        <button type="submit" class="btn btn-primary">
                                            <i class="feather-save me-2"></i> Update Quiz
                                        </button>
                    ...
                    <div class="col-lg-4">
                        <div class="card stretch stretch-full">
                            <div class="card-body">
                                ...
                                <hr>
                                <h6 class="mb-3">Rekomendasi Passing Grade</h6>
