                                        ...
                                        <tbody>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center gap-3">
                                                        <div class="avatar-image">
                                                            <img src="{{ asset('backend/assets/images/avatar/2.png') }}" alt="" class="img-fluid" />
                                                        </div>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center gap-3">
                                                        <div class="avatar-image">
                                                            <img src="{{ asset('backend/assets/images/avatar/3.png') }}" alt="" class="img-fluid" />
                                                        </div>
                                                        <a href="javascript:void(0);">
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center gap-3">
                                                        <div class="avatar-image">
                                                            <img src="{{ asset('backend/assets/images/avatar/4.png') }}" alt="" class="img-fluid" />
                                                        </div>
                                                        <a href="javascript:void(0);">
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center gap-3">
                                                        <div class="avatar-image">
                                                            <img src="{{ asset('backend/assets/images/avatar/5.png') }}" alt="" class="img-fluid" />
                                                        </div>
                                                        <a href="javascript:void(0);">
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center gap-3">
                                                        <div class="avatar-image">
                                                            <img src="{{ asset('backend/assets/images/avatar/6.png') }}" alt="" class="img-fluid" />
                                                        </div>
                                                        <a href="javascript:void(0);">
                                ...
                                <div class="mb-3">
                                    <div class="mb-4 pb-1 d-flex">
                                        <div class="d-flex w-50 align-items-center me-3">
                                            <img src="{{ asset('backend/assets/images/brand/app-store.png') }}" alt="laravel-logo" class="me-3" width="35" />
                                            <div>
                                    ...
                                    <div class="mb-4 pb-1 d-flex">
                                        <div class="d-flex w-50 align-items-center me-3">
                                            <img src="{{ asset('backend/assets/images/brand/figma.png') }}" alt="figma-logo" class="me-3" width="35" />
                                            <div>
                                    ...
                                    <div class="mb-4 pb-1 d-flex">
                                        <div class="d-flex w-50 align-items-center me-3">
                                            <img src="{{ asset('backend/assets/images/brand/facebook.png') }}" alt="vue-logo" class="me-3" width="35" />
                                            <div>
                                    ...
                                    <div class="mb-4 pb-1 d-flex">
                                        <div class="d-flex w-50 align-items-center me-3">
                                            <img src="{{ asset('backend/assets/images/brand/github.png') }}" alt="react-logo" class="me-3" width="35" />
                                            <div>
                                    ...
                                    <div class="d-flex">
                                        <div class="d-flex w-50 align-items-center me-3">
                                            <img src="{{ asset('backend/assets/images/brand/paypal.png') }}" alt="sketch-logo" class="me-3" width="35" />
                                            <div>
