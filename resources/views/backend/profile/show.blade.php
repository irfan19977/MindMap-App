                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="d-flex gap-2 text-center pt-4">
                                    ...
                                    <a href="javascript:void(0);" class="w-50 btn btn-primary" data-bs-toggle="modal" data-bs-target="#editProfileModal">
                                                    ...
                                                    <div class="p-4">
                                                        <div class="d-sm-flex align-items-center">
                                                            <div class="wd-50 ht-50 p-2 bg-gray-200 rounded-2">
                                                                <img src="{{ asset('backend/assets/images/brand/github.png') }}" class="img-fluid" alt="">
                                                            </div>
                                                        ...
                                                        <div class="d-flex align-items-center justify-content-between">
                                                            <div class="img-group lh-0 ms-3">
                                                                <a href="javascript:void(0);" class="avatar-image avatar-sm" data-bs-toggle="tooltip" data-bs-trigger="hover" title="Janette Dalton">
                                                                    <img src="{{ asset('backend/assets/images/avatar/2.png') }}" class="img-fluid" alt="image">
                                                                </a>
                                                                <a href="javascript:void(0);" class="avatar-image avatar-sm" data-bs-toggle="tooltip" data-bs-trigger="hover" title="Michael Ksen">
                                                                    <img src="{{ asset('backend/assets/images/avatar/3.png') }}" class="img-fluid" alt="image">
                                                                </a>
                                                                <a href="javascript:void(0);" class="avatar-image avatar-sm" data-bs-toggle="tooltip" data-bs-trigger="hover" title="Socrates Itumay">
                                                                    <img src="{{ asset('backend/assets/images/avatar/4.png') }}" class="img-fluid" alt="image">
                                                                </a>
                                                                <a href="javascript:void(0);" class="avatar-image avatar-sm" data-bs-toggle="tooltip" data-bs-trigger="hover" title="Marianne Audrey">
                                                                    <img src="{{ asset('backend/assets/images/avatar/5.png') }}" class="img-fluid" alt="image">
                                                                </a>
                                                                <a href="javascript:void(0);" class="avatar-image avatar-sm" data-bs-toggle="tooltip" data-bs-trigger="hover" title="Marianne Audrey">
                                                                    <img src="{{ asset('backend/assets/images/avatar/6.png') }}" class="img-fluid" alt="image">
                                                                </a>
                                            ...
                                            <div class="col-xxl-6 col-xl-12 col-md-6">
                                                <div class="border border-dashed border-gray-5 rounded">
                                                    <div class="p-4">
                                                        <div class="d-sm-flex align-items-center">
                                                            <div class="wd-50 ht-50 p-2 bg-gray-200 rounded-2">
                                                                <img src="{{ asset('backend/assets/images/brand/figma.png') }}" class="img-fluid" alt="">
                                                            </div>
                                                            <div class="ms-0 mt-4 ms-sm-3 mt-sm-0">
                                        ...
                                        <div class="row">
                                            <div class="col-xxl-6 col-xl-12 col-lg-6">
                                                <div class="px-4 py-2 mb-4 d-sm-flex justify-content-between border border-dashed border-gray-3 rounded-1 position-relative">
                                                    <div class="d-sm-flex align-items-center">
                                                        <div class="wd-100">
                                                            <img src="{{ asset('backend/assets/images/payment/mastercard.svg') }}" class="img-fluid" alt="">
                                                        </div>
                                            ...
                                            <div class="col-xxl-6 col-xl-12 col-lg-6">
                                                <div class="px-4 py-2 mb-4 d-sm-flex justify-content-between border border-dashed border-gray-3 rounded-1">
                                                    <div class="d-sm-flex align-items-center">
                                                        <div class="wd-100">
                                                            <img src="{{ asset('backend/assets/images/payment/visa.svg') }}" class="img-fluid" alt="">
                                                        </div>
                                                        <div class="ms-0 ms-sm-3">
                                                            <div class="text-dark fw-bold mb-2">Alexandra Della</div>
                                            ...
                                            <div class="col-xxl-6 col-xl-12 col-lg-6">
                                                <div class="px-4 py-2 mb-4 d-sm-flex justify-content-between border border-dashed border-gray-3 rounded-1">
                                                    <div class="d-sm-flex align-items-center">
                                                        <div class="wd-100">
                                                            <img src="{{ asset('backend/assets/images/payment/american-express.svg') }}" class="img-fluid" alt="">
                                                        </div>
                                                        <div class="ms-0 ms-sm-3">
                                                            <div class="text-dark fw-bold mb-2">Alexandra Della</div>
                                            ...
                                            <div class="col-xxl-6 col-xl-12 col-lg-6">
                                                <div class="px-4 py-2 mb-4 d-sm-flex justify-content-between border border-dashed border-gray-3 rounded-1">
                                                    <div class="d-sm-flex align-items-center">
                                                        <div class="wd-100">
                                                            <img src="{{ asset('backend/assets/images/payment/discover.svg') }}" class="img-fluid" alt="">
                                                        </div>
                                                        <div class="ms-0 ms-sm-3">
                                                            <div class="text-dark fw-bold mb-2">Alexandra Della</div>
                                ...
                                <div class="tab-pane fade" id="connectionTab" role="tabpanel">
                                    <div class="development-connections p-4 pb-0">
                                        ...
                                        <div class="hstack justify-content-between p-4 mb-3 border border-dashed border-gray-3 rounded-1">
                                            <div class="hstack me-4">
                                                <div class="wd-40">
                                                    <img src="{{ asset('backend/assets/images/brand/google-drive.png') }}" class="img-fluid" alt="">
                                                </div>
                                                <div class="ms-4">
                                        ...
                                        <div class="hstack justify-content-between p-4 mb-3 border border-dashed border-gray-3 rounded-1">
                                            <div class="hstack me-4">
                                                <div class="wd-40">
                                                    <img src="{{ asset('backend/assets/images/brand/dropbox.png') }}" class="img-fluid" alt="">
                                                </div>
                                                <div class="ms-4">
                                        ...
                                        <div class="hstack justify-content-between p-4 mb-3 border border-dashed border-gray-3 rounded-1">
                                            <div class="hstack me-4">
                                                <div class="wd-40">
                                                    <img src="{{ asset('backend/assets/images/brand/gitlab.png') }}" class="img-fluid" alt="">
                                                </div>
                                                <div class="ms-4">
                                        ...
                                        <div class="hstack justify-content-between p-4 mb-3 border border-dashed border-gray-3 rounded-1">
                                            <div class="hstack me-4">
                                                <div class="wd-40">
                                                    <img src="{{ asset('backend/assets/images/brand/shopify.png') }}" class="img-fluid" alt="">
                                                </div>
                                                <div class="ms-4">
                                        ...
                                        <div class="hstack justify-content-between p-4 border border-dashed border-gray-3 rounded-1">
                                            <div class="hstack me-4">
                                                <div class="wd-40">
                                                    <img src="{{ asset('backend/assets/images/brand/whatsapp.png') }}" class="img-fluid" alt="">
                                                </div>
                                                <div class="ms-4">
                                    ...
                                    <div class="social-connections px-4 mb-4">
                                        ...
                                        <div class="hstack justify-content-between p-4 mb-3 border border-dashed border-gray-3 rounded-1">
                                            <div class="hstack me-4">
                                                <div class="wd-40">
                                                    <img src="{{ asset('backend/assets/images/brand/facebook.png') }}" class="img-fluid" alt="">
                                                </div>
                                                <div class="ms-4">
                                        ...
                                        <div class="hstack justify-content-between p-4 mb-3 border border-dashed border-gray-3 rounded-1">
                                            <div class="hstack me-4">
                                                <div class="wd-40">
                                                    <img src="{{ asset('backend/assets/images/brand/instagram.png') }}" class="img-fluid" alt="">
                                                </div>
                                                <div class="ms-4">
                                        ...
                                        <div class="hstack justify-content-between p-4 mb-3 border border-dashed border-gray-3 rounded-1">
                                            <div class="hstack me-4">
                                                <div class="wd-40">
                                                    <img src="{{ asset('backend/assets/images/brand/twitter.png') }}" class="img-fluid" alt="">
                                                </div>
                                                <div class="ms-4">
                                        ...
                                        <div class="hstack justify-content-between p-4 mb-3 border border-dashed border-gray-3 rounded-1">
                                            <div class="hstack me-4">
                                                <div class="wd-40">
                                                    <img src="{{ asset('backend/assets/images/brand/spotify.png') }}" class="img-fluid" alt="">
                                                </div>
                                                <div class="ms-4">
                                        ...
                                        <div class="hstack justify-content-between p-4 mb-3 border border-dashed border-gray-3 rounded-1">
                                            <div class="hstack me-4">
                                                <div class="wd-40">
                                                    <img src="{{ asset('backend/assets/images/brand/youtube.png') }}" class="img-fluid" alt="">
                                                </div>
                                                <div class="ms-4">
                                        ...
                                        <div class="hstack justify-content-between p-4 border border-dashed border-gray-3 rounded-1">
                                            <div class="hstack me-4">
                                                <div class="wd-40">
                                                    <img src="{{ asset('backend/assets/images/brand/pinterest.png') }}" class="img-fluid" alt="">
                                                </div>
                                                <div class="ms-4">
