...
<html lang="en">
  <head>
    ...
    <title>MindMap - Confirm Password</title>
    <!-- Bootstrap Core CSS-->
  ...
  <body class="top" id="page-top" data-spy="scroll" data-target=".navbar-fixed-top">
    ...
    <!-- Header-->
    <header class="intro intro-fullscreen" data-background="{{ asset('frontend/img/main/36.jpg') }}">
          ...
          <div class="row wow fadeIn">
            <div class="col-md-4 col-md-offset-4">
              <div class="text-center mb-4">
                <i class="ion-ios-shield-outline" style="font-size: 64px; color: #007bff;"></i>
              </div>
              
              <div class="alert alert-warning">
                <h4><i class="ion-ios-lock-outline"></i> Security Check</h4>
              ...
              <form method="POST" action="{{ route('password.confirm') }}" class="form-signin">
                ...
                <div class="form-group">
                  ...
                  <input class="form-control input-lg" id="password" type="password" name="password" placeholder="Enter your password" required autocomplete="current-password">
                  @error('password')
              ...
              <div class="text-center mt-3">
                <p><a href="{{ route('dashboard') }}" class="text-muted">Cancel</a></p>
              </div>
            </div>
          </div>
        </div>
