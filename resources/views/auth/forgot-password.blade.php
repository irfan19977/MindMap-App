...
<html lang="en">
  <head>
    ...
    <title>MindMap - Forgot Password</title>
    <!-- Bootstrap Core CSS-->
  ...
  <body class="top" id="page-top" data-spy="scroll" data-target=".navbar-fixed-top">
    ...
    <!-- Header-->
    <header class="intro intro-fullscreen" data-background="{{ asset('frontend/img/main/35.jpg') }}">
          ...
          <div class="row wow fadeIn">
            <div class="col-md-4 col-md-offset-4">
              <div class="text-center mb-4">
                <i class="ion-ios-help-circle-outline" style="font-size: 64px; color: #007bff;"></i>
              </div>
              ...
              @if (session('status'))
                  <div class="alert alert-success">
                      <i class="ion-ios-checkmark-circle-outline"></i> {{ session('status') }}
                  </div>
              @endif
              ...
              <form method="POST" action="{{ route('password.email') }}" class="form-signin">
                ...
                <div class="form-group">
                  ...
                  <input class="form-control input-lg" id="email" type="email" name="email" :value="old('email')" placeholder="Email address" required autofocus>
                  @error('email')
                ...
                <button class="btn btn-lg btn-dark btn-block" type="submit">
                  <i class="ion-ios-mail-outline"></i> Email Password Reset Link
                </button>
              </form>
