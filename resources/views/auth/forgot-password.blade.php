...
<head>
    <title>Lupa Password - MindMap</title>
...
<body>
    <div class="login-container">
        <div class="login-card">
            ...
            <p class="login-subtitle">Masukkan email Anda untuk mereset password</p>
            ...
            <form method="POST" action="{{ route('password.email') }}">
                ...
                <div class="mb-3">
                    ...
                    <input type="email" class="form-control" id="email" name="email" placeholder="Masukkan email Anda" value="{{ old('email') }}" required autofocus autocomplete="email">
                    @error('email')
