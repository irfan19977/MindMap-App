                    ...
                    <div class="de-flex sm-pt10">
                        <div class="de-flex-col">
                            ...
                            <div id="logo">
                                <a href="/">
                                    ...
                                    <img class="logo-mobile" src="{{ asset('frontend/images/logo-mobile.webp') }}" alt="" >
                                </a>
                            </div>
                            <!-- logo end -->
                        </div>
                        ...
                        <div class="de-flex-col">
                            <div class="menu_side_area">
                                @guest
                                <a href="{{ route('login') }}?intended={{ urlencode(request()->fullUrl()) }}" class="btn-main fx-slide"><span>Login</span></a>
                                @endauth
                                @auth
